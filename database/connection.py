...
def init_db():
    with db() as c:
        ...
        CREATE TABLE IF NOT EXISTS groups(id INTEGER PRIMARY KEY,title TEXT,username TEXT,first_seen TEXT,last_seen TEXT,enabled INTEGER DEFAULT 1,morning INTEGER DEFAULT 1,night INTEGER DEFAULT 1,prize TEXT DEFAULT '',start_time TEXT DEFAULT '10:00',end_time TEXT DEFAULT '00:00',challenge_interval INTEGER DEFAULT 25,challenge_points INTEGER DEFAULT 10,image_chance INTEGER DEFAULT 35,morning_time TEXT DEFAULT '08:00',night_time TEXT DEFAULT '22:00');
        ...
        CREATE TABLE IF NOT EXISTS challenges(id INTEGER PRIMARY KEY AUTOINCREMENT,group_id INTEGER,question TEXT,answer TEXT,category TEXT,points INTEGER,status TEXT DEFAULT 'active',winner INTEGER,created TEXT,answered TEXT,media_url TEXT,media_title TEXT,media_revealed INTEGER DEFAULT 0);
