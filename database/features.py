...
def claim_chest(gid,uid):
    ...
    with db() as c:
        ...
        pts=max(1,int(s['chest_points'])); c.execute('INSERT INTO chests VALUES(?,?,?,?,1) ON CONFLICT(group_id,user_id,day) DO UPDATE SET claimed=1',(gid,uid,day,pts)); return pts
