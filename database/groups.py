...
def upsert(chat):
    with db() as c:
        c.execute("""INSERT INTO groups
            (id,title,username,first_seen,last_seen,enabled,morning,night,prize,start_time,end_time,challenge_interval,challenge_points,image_chance,morning_time,night_time,prize1,prize2,prize3)
...
def setting(g,col,v):
    allowed={'morning','night','start_time','end_time','challenge_interval','challenge_points','image_chance','morning_time','night_time','prize1','prize2','prize3'}
