...
from database.points import previous_week, close_week, close_season, start_new_season, users_with_points, find_group_user, add, mine, points_ledger, active_week, season_status, user_points_summary
...
def show_group_text(g):
    return (
        ...
        f"⭐ Pontos por desafio: <b>10</b> (fixo)\n"
...
async def save_config(
    ...
    try:
        ...
        # PONTOS
            ...
            # Compatibilidade com versões antigas: desafios valem sempre 10 pontos.
            setting(gid, "challenge_points", 10)
            msg = "Os desafios valem fixamente 10 pontos."
